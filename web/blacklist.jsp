...
<body>
    ...
    <div class="col-lg-6" style="padding:0px; margin-bottom:50px;">
        <form class="form-inline" action="helper/doSearchName.jsp" method="post">
        ...
        {
              query0 = "select * from transactions tr join members mb on tr.userid = mb.userid join jobs jb on tr.jobid = jb.jobid join departments dp on jb.departmentid = dp.departmentid where tr.status = '-3' and mb.name like '%"+searchname+"%' ";
        }
        ...
        %>
				...
				rs0.beforeFirst();
                    ...
                    <div class="col-md-5 inside-box" style="margin-left: 6%;">
                        ...
                        <div class="col-md-12" style="word-wrap: break-word; margin-bottom: 10px;">
                            <b>Notes: </b><%=rs0.getString("tr.note")%>
                        </div>
                        ...
                        <div class="col-md-12" style="margin-bottom: 20px;">
                            ...
                            <%
                                ...
                                else if(last_status.equals("4"))
                                {
                                    last_status = "Offering Letter  ";
                                }
                            %>
                            <div class="col-md-12" style="margin-bottom: 20px;">
                            <b>Last proccess: </b>&nbsp;
			...
			{
			%>
                        <a href = "blacklist.jsp?page=<%=i%>" style="text-decoration:none; padding-right:3px"> <%=i%> </a>
                        <%   
                        }
			%>
                        <br />
